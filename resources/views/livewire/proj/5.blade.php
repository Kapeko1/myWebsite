...
@section("Images")
    <div class="carousel relative"
         x-data="{
             current: 0,
             images: [
                 '{{ Vite::asset('resources/img/projects/digi/1.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/digi/2.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/digi/3.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/digi/4.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/digi/5.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/digi/6.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/digi/7.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/digi/8.png', ) }}',
             ],
             showModal: false,
             modalImage: '',
             touchStartX: 0,
