...
@section("Images")
    <div class="carousel relative"
         x-data="{
             current: 0,
             images: [
                 '{{ asset('img/projects/digi/1.png', ) }}',
                 '{{ asset('img/projects/digi/2.png', ) }}',
                 '{{ asset('img/projects/digi/3.png', ) }}',
                 '{{ asset('img/projects/digi/4.png', ) }}',
                 '{{ asset('img/projects/digi/5.png', ) }}',
                 '{{ asset('img/projects/digi/6.png', ) }}',
                 '{{ asset('img/projects/digi/7.png', ) }}',
                 '{{ asset('img/projects/digi/8.png', ) }}',
             ],
             showModal: false,
             modalImage: '',
             touchStartX: 0,
