...
@section("Images")
    <div class="carousel relative"
         x-data="{
             current: 0,
             images: [
                 '{{ asset('resources/img/projects/open4u/0.png', ) }}',
                 '{{ asset('resources/img/projects/open4u/1.png', ) }}',
                 '{{ asset('resources/img/projects/open4u/2.png', ) }}',
                 '{{ asset('resources/img/projects/open4u/3.png', ) }}',
                 '{{ asset('resources/img/projects/open4u/4.png', ) }}',
                 '{{ asset('resources/img/projects/open4u/5.png', ) }}',
                 '{{ asset('resources/img/projects/open4u/6.png', ) }}',
             ],
             showModal: false,
             modalImage: '',
             touchStartX: 0,
