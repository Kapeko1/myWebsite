...
<div class="carousel relative"
     x-data="{
             current: 0,
             images: [
                 '{{ Vite::asset('resources/img/projects/m4i/1.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/m4i/2.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/m4i/3.png', ) }}',
                 '{{ Vite::asset('resources/img/projects/m4i/4.png', ) }}',
             ],
             showModal: false,
             modalImage: '',
             touchStartX: 0,
